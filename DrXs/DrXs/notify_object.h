...
typedef enum _DRX_NOTIF_OBJECT_ACTION
{
	ListNotif,
	ClearNotif
} DRX_NOTIF_OBJECT_ACTION;
...
NTSTATUS listNotifOrClearObject(SIZE_T szBufferIn, PVOID bufferIn, PDRX_BUFFER outBuffer, DRX_NOTIF_OBJECT_ACTION action);